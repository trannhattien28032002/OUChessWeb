...
//    [Header("Hover Art stuff")]
//    [SerializeField] private Material hoverMaterial;
//    [Header("Highlight Tiles Art stuff")]
//    [SerializeField] private Material highlightMaterial;
//    [Header("Options board")]
...
//            Debug.Log("current hover: " + currentHover);
//            //If we are hovering over a tile after not hovering any tiles
//            if (currentHover == -Vector2Int.one)
//            {
//                currentHover = hitPosition;
//                tiles[hitPosition.x, hitPosition.y].layer = LayerMask.NameToLayer("Hover");
//                tiles[hitPosition.x, hitPosition.y].GetComponent<Renderer>().material = hoverMaterial;
//            }
...
//                    tiles[currentHover.x, currentHover.y].GetComponent<Renderer>().material = highlightMaterial;
//                else tiles[currentHover.x, currentHover.y].GetComponent<Renderer>().material = tileMaterial;
...
//        cp.type = type;
//        cp.team = team;
//        // If have many material
//        //cp.GetComponent<MeshRenderer>().material = teamMaterials[((team == 0) ? 0 : 6) + ((int)type - 1)];

//        // If have just 2 material
//        cp.GetComponent<MeshRenderer>().material = teamMaterials[((team == 0) ? 0 : 1)];
...
//            tiles[availableMoves[i].x, availableMoves[i].y].GetComponent<Renderer>().material = highlightMaterial;
//        }
//    }
...
//            tiles[availableMoves[i].x, availableMoves[i].y].GetComponent<Renderer>().material = tileMaterial;
//        }
